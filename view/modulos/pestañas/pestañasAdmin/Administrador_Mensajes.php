<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 mt-5 mb-5">
            <article id="article1">
                <div class="col-md-12">
                    <h3 class="text-right-xs" style="text-align: center;">Mensajes Recibidos</h3>
                    ...
                    <button href="#VerInfoMensajeAdmin" data-toggle="modal" type="submit" class="btn btn-block btn-color btn-xxl" id="botonMensajesAdmin" style="display: block;margin: auto;width: 50%;"><span class="ion-clipboard"></span> Ver Listado</button>
