...
<head>
    ...
    <link href="view/presentacion/css/bootstrap.min.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="view/presentacion/js/Administrador_Empleados.js"></script>
    <script type="text/javascript" src="view/presentacion/js/Administrador_Clientes.js"></script>
    <script type="text/javascript" src="view/presentacion/js/Administrador_Productos.js"></script>
    <script type="text/javascript" src="view/presentacion/js/Administrador_Promociones.js"></script>
